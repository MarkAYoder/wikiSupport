...
$footer = 
"<br><br><hr>\n" .
"<img align=right height=100 src=\"" . &findpath("chirpcov.png") . "\">\n" .
    "<font size=-2>\n";
if(bookType() eq 'dtsp') {
    print "dtsp found\n";
    ...
    $footer .= "McClellan, Schafer, and Yoder, <i>Signal Processing First</i>, ISBN 0-13-065562-7. \n";
  }
$footer .=
"<br>
...
"<p><font size=-2 color=gray><a href=\"mailto:Mark.A.Yoder_at_Rose-Hulman.edu?subject=DSP_First_Web_Feedback&body=$file\">Click here</a> to submit bug reports, comments, \n" .
