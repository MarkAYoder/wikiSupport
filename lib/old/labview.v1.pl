...
document.write('	codebase=\"http://ftp.ni.com/support/softlib/labview/labview_runtime/$num/windows/LabVIEW${num2}RuntimeEngine.exe\" ');
...
document.write('</a>');
document.write('<font size=-2 color=gray>' + BrowserDetect.OS + ' Version 8.5.1         <a href=\"" . findpath('labview.htm') . "\">LabVIEW tips</a></font><p>');
